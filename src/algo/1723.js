...
const __lcExamples = [
  { args: [[3, 2, 3], 3], expected: 3, comment: "// 输入：jobs = [3,2,3], k = 3  输出：3" },
  { args: [[1, 2, 4, 7, 8], 2], expected: 11, comment: "// 输入：jobs = [1,2,4,7,8], k = 2  输出：11" },
];

__lcRunExamples(minimumTimeRequired, __lcExamples);