...
const __lcExamples = [
  { args: [3, 1], expected: 0, comment: '// 输入：n = 3, k = 1  输出：0' },
  { args: [4, 11], expected: 1, comment: '// 输入：n = 4, k = 11  输出：1' },
  { args: [1, 1], expected: 0, comment: '// 输入：n = 1, k = 1  输出：0' },
  { args: [2, 3], expected: 1, comment: '// 输入：n = 2, k = 3  输出：1' },
]

__lcRunExamples(findKthBit, __lcExamples)
