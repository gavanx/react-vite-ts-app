...
const __lcExamples = [
  {
    args: [4, 0, [1, 2], 4],
    expected: [0, -1, -1, 1],
    comment: '// 输入：n = 4, p = 0, banned = [1,2], k = 4  输出：[0,-1,-1,1]',
  },
  {
    args: [5, 0, [2, 4], 3],
    expected: [0, -1, -1, -1, -1],
    comment: '// 输入：n = 5, p = 0, banned = [2,4], k = 3  输出：[0,-1,-1,-1,-1]',
  },
  {
    args: [4, 2, [0, 1, 3], 1],
    expected: [-1, -1, 0, -1],
    comment: '// 输入：n = 4, p = 2, banned = [0,1,3], k = 1  输出：[-1,-1,0,-1]',
  },
]
