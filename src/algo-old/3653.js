...
const __lcExamples = [
  { args: [[1, 1, 1], [[0, 2, 1, 4]]], expected: 4, comment: "// 输入：nums = [1,1,1], queries = [[0,2,1,4]]  输出：4" },
  { args: [[2, 3, 1, 5, 4], [[1, 4, 2, 3], [0, 2, 1, 2]]], expected: 31, comment: "// 输入：nums = [2,3,1,5,4], queries = [[1,4,2,3],[0,2,1,2]]  输出：31" },
];
