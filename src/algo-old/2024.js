...
const __lcExamples = [
  { args: ['TTFF', 2], expected: 4, comment: '// 输入：answerKey = "TTFF", k = 2  输出：4' },
  { args: ['TFFT', 1], expected: 3, comment: '// 输入：answerKey = "TFFT", k = 1  输出：3' },
  {
    args: ['TTFTTFTT', 1],
    expected: 5,
    comment: '// 输入：answerKey = "TTFTTFTT", k = 1  输出：5',
  },
]

__lcRunExamples(maxConsecutiveAnswers, __lcExamples)
