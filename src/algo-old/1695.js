...
const __lcExamples = [
  { args: [[4, 2, 4, 5, 6]], expected: 17, comment: '// 输入：nums = [4,2,4,5,6]  输出：17' },
  {
    args: [[5, 2, 1, 2, 5, 2, 1, 2, 5]],
    expected: 8,
    comment: '// 输入：nums = [5,2,1,2,5,2,1,2,5]  输出：8',
  },
]

__lcRunExamples(maximumUniqueSubarray, __lcExamples)
