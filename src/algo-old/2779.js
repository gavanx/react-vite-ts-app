...
const __lcExamples = [
  { args: [[4, 6, 1, 2], 2], expected: 3, comment: "// 输入：nums = [4,6,1,2], k = 2  输出：3" },
  { args: [[1, 1, 1, 1], 10], expected: 4, comment: "// 输入：nums = [1,1,1,1], k = 10  输出：4" },
];

__lcRunExamples(maximumBeauty, __lcExamples);