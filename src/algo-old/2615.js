...
const __lcExamples = [
  { args: [[1, 3, 1, 1, 2]], expected: [5, 0, 3, 4, 0], comment: "// 输入：nums = [1,3,1,1,2]  输出：[5,0,3,4,0]" },
  { args: [[0, 5, 3]], expected: [0, 0, 0], comment: "// 输入：nums = [0,5,3]  输出：[0,0,0]" },
];

__lcRunExamples(distance, __lcExamples);