...
const __lcExamples = [
  {
    ...
    expected: 'abab',
    comment: '// 输入：lcp = [[4,0,2,0],[0,3,0,1],[2,0,2,0],[0,1,0,1]]  输出：abab',
  },
  {
    args: [
      [
    ...
    expected: 'aaaa',
    comment: '// 输入：lcp = [[4,3,2,1],[3,3,2,1],[2,2,2,1],[1,1,1,1]]  输出：aaaa',
  },
]

__lcRunExamples(findTheString, __lcExamples)
