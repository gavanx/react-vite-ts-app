...
const __lcExamples = [
  { args: ["abcde", "cdeab"], expected: true, comment: "// 输入：s = \"abcde\", goal = \"cdeab  输出：true" },
  { args: ["abcde", "abced"], expected: false, comment: "// 输入：s = \"abcde\", goal = \"abced  输出：false" },
];

__lcRunExamples(rotateString, __lcExamples);
