...
const __lcExamples = [
  { args: ["32"], expected: 3, comment: "// 输入：n = \"32  输出：3" },
  { args: ["82734"], expected: 8, comment: "// 输入：n = \"82734  输出：8" },
  { args: ["27346209830709182346"], expected: 9, comment: "// 输入：n = \"27346209830709182346  输出：9" },
];

__lcRunExamples(minPartitions, __lcExamples);