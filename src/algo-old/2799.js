...
const __lcExamples = [
  { args: [[1, 3, 1, 2, 2]], expected: 4, comment: '// 输入：nums = [1,3,1,2,2]  输出：4' },
  { args: [[5, 5, 5, 5]], expected: 10, comment: '// 输入：nums = [5,5,5,5]  输出：10' },
]

__lcRunExamples(countCompleteSubarrays, __lcExamples)
