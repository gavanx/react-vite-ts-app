...
const __lcExamples = [
  { args: ["52233"], expected: 4, comment: "// 输入：s = \"52233  输出：4" },
  { args: ["5494"], expected: 4, comment: "// 输入：s = \"5494  输出：4" },
  { args: ["1111111"], expected: 2, comment: "// 输入：s = \"1111111  输出：2" },
];

__lcRunExamples(longestSemiRepetitiveSubstring, __lcExamples);