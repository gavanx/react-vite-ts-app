...
const __lcExamples = [
  { args: [[2, 1, 2]], expected: 1, comment: '// 输入：nums = [2,1,2]  输出：1' },
  { args: [[2, 8, 2, 2, 5]], expected: 2, comment: '// 输入：nums = [2,8,2,2,5]  输出：2' },
  {
    args: [[1]],
    expected: '-1',
  },
...
__lcRunExamples(smallestBalancedIndex, __lcExamples)
