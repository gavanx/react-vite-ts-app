...
var canReach = function (s, minJump, maxJump) {
  ...
  for (let i = 0; i < n; i++) {
    if (s[i] === '0' && vis[i]) {
      const mx = Math.min(i + maxJump, n - 1)
...
const __lcExamples = [
  {
    args: ['011010', 2, 3],
    expected: true,
    comment: '// 输入：s = "011010", minJump = 2, maxJump = 3  输出：true',
  },
  {
    args: ['01101110', 2, 3],
    expected: false,
    comment: '// 输入：s = "01101110", minJump = 2, maxJump = 3  输出：false',
  },
]
