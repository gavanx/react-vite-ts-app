...
const __lcExamples = [
  { args: [[10, 12, 13, 14]], expected: 1, comment: "// 输入：nums = [10,12,13,14]  输出：1" },
  { args: [[1, 2, 3, 4]], expected: 1, comment: "// 输入：nums = [1,2,3,4]  输出：1" },
  { args: [[999, 19, 199]], expected: 10, comment: "// 输入：nums = [999,19,199]  输出：10" },
];

__lcRunExamples(minElement, __lcExamples);