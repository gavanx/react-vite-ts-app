...
console.log(
  maxJumps(
    [
      40, 98, 14, 22, 45, 71, 20, 19, 26, 9, 29, 64, 76, 66, 32, 79, 14, 83, 62, 39, 69, 25, 92, 79,
      70, 34, 22, 19, 41, 26, 5, 82, 38,
    ],
    6
  )
)
...
const __lcExamples = [
  {
    args: [[6, 4, 14, 6, 8, 13, 9, 7, 10, 6, 12], 2],
    expected: 4,
    comment: '// 输入：arr = [6,4,14,6,8,13,9,7,10,6,12], d = 2  输出：4',
  },
  {
    args: [[3, 3, 3, 3, 3], 3],
    expected: 1,
    comment: '// 输入：arr = [3,3,3,3,3], d = 3  输出：1',
  },
  {
    args: [[7, 6, 5, 4, 3, 2, 1], 1],
    expected: 7,
    comment: '// 输入：arr = [7,6,5,4,3,2,1], d = 1  输出：7',
  },
  {
    args: [[7, 1, 7, 1, 7, 1], 2],
    expected: 2,
    comment: '// 输入：arr = [7,1,7,1,7,1], d = 2  输出：2',
  },
