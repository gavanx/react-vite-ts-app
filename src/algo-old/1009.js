...
const __lcExamples = [
  { args: [5], expected: 2, comment: '// 输入：5  输出：2' },
  { args: [7], expected: 0, comment: '// 输入：7  输出：0' },
  { args: [10], expected: 5, comment: '// 输入：10  输出：5' },
]

__lcRunExamples(bitwiseComplement, __lcExamples)
