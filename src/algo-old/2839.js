var canBeEqual = function (s1, s2) {
  return (
    s1 === s2 ||
    s1[2] + s2[1] + s1[0] + s2[3] === s2 ||
    s1[0] + s2[1] + s1[2] + s2[3] === s2 ||
    s1[2] + s2[3] + s1[0] + s2[1] === s2
  )
}
...
const __lcExamples = [
  {
    args: ['abcd', 'cdab'],
    expected: true,
    comment: '// 输入：s1 = "abcd", s2 = "cdab  输出：true',
  },
  {
    args: ['abcd', 'dacb'],
    expected: false,
    comment: '// 输入：s1 = "abcd", s2 = "dacb  输出：false',
  },
]

__lcRunExamples(canBeEqual, __lcExamples)
